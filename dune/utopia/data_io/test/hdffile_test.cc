...
int file_open_tester() {
    auto file1 = std::make_shared<HDFFile>(
        "/Users/haraldmack/Desktop/hdf5testfile.h5", "w");
    auto file2 = std::make_shared<HDFFile>(
        "/Users/haraldmack/Desktop/hdf5testfile.h5", "r");
    auto file3 = std::make_shared<HDFFile>(
        "/Users/haraldmack/Desktop/hdf5testfile.h5", "r+");
    bool caught = false;
    try {
    ...
    auto file5 = std::make_shared<HDFFile>(
        "/Users/haraldmack/Desktop/hdftestfile.h5", "a");
    caught = false;
    try {
...
int file_func_tester() {
    ...
    if (group_test < 0) {
        std::cerr << "group opening failed, does not exist at path"
                  << std::endl;
        return -1;
    }
    H5Gclose(group_test);
