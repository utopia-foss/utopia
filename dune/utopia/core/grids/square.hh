...
protected:
    ...
    // TODO: Fix this one: Check whether a pair of neighbors was added or just
    //       a single neighbor. Then adapt the neighbor adding algorithm below
    //       by making it dependent on this check.
