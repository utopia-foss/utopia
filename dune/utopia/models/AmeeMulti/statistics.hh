...
/**
 * @brief      Pairwise summation of range [start, end)
 *
 * @param[in]  start          The start iterator of the range to sum
 * @param[in]  end            The end iterator of the range to sum
 *
 *
 * @return     sum(start,end)
 */
template <typename InputIterator>
double sum(InputIterator start, InputIterator end)
{
    if (start == end)
    {
        return 0.;
    ...
    else
    {
        ...
        double s = sum(start, start + m) + sum(start + m, end);
        return s;
    }
}
...
double sum(InputIterator start, InputIterator end, F f, Args... args)
{
    if (start == end)
    {
        return 0.;
 ...
 */
template <typename InputIterator>
double sum_kahan(InputIterator start, InputIterator end)
{
    if (start == end)
    {
        return 0.;
...
double sum_kahan(InputIterator start, InputIterator end, F f)
{
    if (start == end)
    {
        return 0.;
...
double moment(int order, InputIterator start, InputIterator end, Getter getter)
{
    if (start == end)
    {
        return 0;
 ...
 * returning something else, for instance an element contained in the object the
 * iterator points to.
 *
 *
 *
 ...
 */
template <typename InputIterator>
double moment(int order, InputIterator start, InputIterator end)
{
    return moment(order, start, end, [](auto& value) { return value; });
}
...
double arithmetic_mean(InputIterator start, InputIterator end, Elementgetter getter)
{
    return moment<InputIterator, Elementgetter>(1, start, end, getter);
}
 ...
 */
template <typename InputIterator, typename Elementgetter>
double harmonic_mean(InputIterator start, InputIterator end, Elementgetter getter)
{
    if (start == end)
    {
        return 0;
 ...
 */
template <typename InputIterator>
double arithmetic_mean(InputIterator start, InputIterator end)
{
    return moment<InputIterator>(1, start, end);
}
 ...
 */
template <typename InputIterator>
double harmonic_mean(InputIterator start, InputIterator end)
{
    return harmonic_mean(start, end, [](auto& value) { return value; });
}
/**
 ...
 */
template <typename InputIterator, typename Elementgetter>
double central_moment(int order, InputIterator start, InputIterator end, Elementgetter getter)
{
    // double c = 0;
...
template <typename InputIterator>
double central_moment(int order, InputIterator start, InputIterator end)
{
    return central_moment(order, start, end, [](auto& value) { return value; });
}
...
template <typename InputIterator, typename Elementgetter>
double variance(InputIterator start, InputIterator end, Elementgetter getter)
{
    double n = 0;
    double mean = 0;
    double M2 = 0;
...
template <typename InputIterator>
double variance(InputIterator start, InputIterator end)
{
    return variance(start, end, [](auto& value) { return value; });
}
 ...
 */
template <typename InputIterator, typename Elementgetter>
double stddev(InputIterator start, InputIterator end, Elementgetter getter)
{
 ...
 */
template <typename InputIterator>
double stddev(InputIterator start, InputIterator end)
{
 ...
 */
template <typename InputIterator, typename Elementgetter>
double skewness(InputIterator start, InputIterator end, Elementgetter getter)
{
    double n = 0;
    double mean = 0;
    double M2 = 0;
 ...
 */
template <typename InputIterator>
double skewness(InputIterator start, InputIterator end)
{
    return skewness(start, end, [](auto& value) { return value; });
}
...
template <typename InputIterator, typename Elementgetter>
double kurtosis(InputIterator start, InputIterator end, Elementgetter getter)
{
    double n = 0;
    double mean = 0;
    double M2 = 0;
    ...
    for (auto it = start; it != end; ++it)
    {
        ...
        term1 = delta * delta_n * n1;
        mean = mean + delta_n;
        M4 = M4 + term1 * delta_n2 * (n * n - 3 * n + 3) + 6 * delta_n2 * M2 -
             4 * delta_n * M3;
        M3 = M3 + term1 * delta_n * (n - 2) - 3 * delta_n * M2;
        M2 = M2 + term1;
    }
 ...
 */
template <typename InputIterator>
double kurtosis(InputIterator start, InputIterator end)
{
    return kurtosis(start, end, [](auto& value) { return value; });
}
 ...
 */
template <typename InputIterator, typename Elementgetter>
double excess_kurtosis(InputIterator start, InputIterator end, Elementgetter getter)
{
 ...
 */
template <typename InputIterator>
double excess_kurtosis(InputIterator start, InputIterator end)
{
 ...
 */
template <typename InputIterator, typename Getter>
auto standardize(InputIterator begin, InputIterator end, Getter&& getter)
{
...
double covariance(InputIterator1 start_first,
                  ...
                  InputIterator2 end_second)
{
    // runs over min(std::distance(start_first, end_first), start_second,
    // end_second))
    return covariance(start_first, end_first, start_second, end_second,
...
double quantile(double percent, InputIterator start, InputIterator end, Comp&& comp, Getter getter)
{
 ...
 */
template <typename InputIterator, typename Getter>
double quantile(double percent, InputIterator start, InputIterator end, Getter getter)
{
    return quantile(
        percent, start, end,
        [](const auto& value1, const auto& value2) { return value1 < value2; }, getter);
}
 ...
 */
template <typename InputIterator>
double quantile(double percent, InputIterator start, InputIterator end)
{
    return quantile(
        percent, start, end,
        [](const auto& value1, const auto& value2) { return value1 < value2; },
        [](auto& value) { return value; });
}
 ...
 */
template <typename InputIterator, typename Elementgetter>
std::pair<typename std::iterator_traits<InputIterator>::value_type, int> mode(
...
std::pair<T, int> mode(InputIterator start, InputIterator end)
{
    return mode(start, end, [](auto& value) { return value; });
}
...
auto median(InputIterator start, InputIterator end, Elementgetter getter, Compare comp)
{
...
*/
template <typename InputIterator, typename Elementgetter>
auto median(InputIterator start, InputIterator end, Elementgetter getter)
{
    return quantile(50., start, end,
 ...
 */
template <typename InputIterator>
auto median(InputIterator start, InputIterator end)
{
    return median(start, end, [](auto& value) { return value; });
}
...
auto minimum(InputIterator start, InputIterator end, Compare comp)
{
 ...
 */
template <typename InputIterator>
auto minimum(InputIterator start, InputIterator end)
{
 ...
 */
template <typename InputIterator, typename Compare>
auto maximum(InputIterator start, InputIterator end, Compare&& comp)
{
 ...
 */
template <typename InputIterator>
auto maximum(InputIterator start, InputIterator end)
{
    return *std::max_element(start, end);
}

// FIXME: write something which lets user choose what functions to use!
/**
 * @brief      General function returning values characterizing the distribution
 *             represented by the values in the range [start, end):
 *             * Mean
 *             * variance
 *             * skewness
 *             * excess-kurtosis
 ...
 */
template <typename InputIterator, typename Elementgetter>
auto describe(InputIterator start, InputIterator end, Elementgetter getter)
{
...
auto describe(InputIter start, InputIter end)
{
    return describe(start, end, [](auto& value) { return value; });
}
 ...
 *                - 3rd quartile
 *                - max
 *             This function assumes that the respective container-type has a
...
auto five_number_summary(
    ...
    std::function<bool(const typename std::iterator_traits<InputIterator>::value_type&,
                       const typename std::iterator_traits<InputIterator>::value_type&)> comp)
{
    return five_number_summary(begin, end, [](auto& value) { return value; }, comp);
}
 ...
 */
template <typename InputIterator, typename Getter>
auto five_number_summary(InputIterator begin, InputIterator end, Getter&& getter)
{
    return five_number_summary(
        begin, end, std::forward<Getter&&>(getter),
        [](const auto& value1, const auto& value2) { return value1 < value2; });
}
 ...
 */
template <typename InputIterator>
auto five_number_summary(InputIterator begin, InputIterator end)
{
    return five_number_summary(
 ...
 */
template <typename InputIterator, typename Getter>
auto sample(double share, InputIterator start, InputIterator end, Getter getter)
{
    std::size_t size = std::distance(start, end);
 ...
 */
template <typename InputIterator>
auto sample(double percent, InputIterator start, InputIterator end)
{
    return sample(percent, start, end, [](auto& value) { return value; });
}
