...
struct CellState {
    ...
    :
        some_state(get_double("some_state", cfg)),
        some_trait(get_int("some_trait", cfg)),
        is_a_vip_cell(false)
    {}
        ...
        CellState(cfg)
    {
        ...
        if (cfg["random_initial_trait"]) {
            if (not get_bool("random_initial_trait", cfg)) {
...
public:
    ...
    :
        ...
        _some_parameter(get_double("some_parameter", this->_cfg)),
        // ...
