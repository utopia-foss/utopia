...
//       ). However, there are also other viable options such an
//       adjacency_matrix. If you are unsure, just have a look in the
//       boost::graph documentation (quick googling helps you ;) )
//
...
//       documentation (e.g.
//       https://www.boost.org/doc/libs/master/libs/graph/doc/using_adjacency_list.html
...
//       NOTE that if you select a VertexContainer that does not provide a fixed
//            internal ordering, thus, no numbered vertex (or edge)
//            descriptors such as for example boost::listS your model will not
//            compile. To make it compile you will need to replace all
//            boost::get(boost::vertex_index_t(), g, v) functions with
//            g[v].id(); this will use the Utopia::GraphEntity id of the vertex
//            to identify the vertex instead of the in this case
//            not-really-accessible vertex_descriptor identification.
//
