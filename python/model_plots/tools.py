...
def colorline(x, y, *, 
    ...
    if x.ndim != 1:
        raise ValueError("Need `x` to have ndim == 1, but had shape {}!"
                         "".format(x.shape))

    elif y.ndim != 1:
        raise ValueError("Need `y` to have ndim == 1, but had shape {}!"
                         "".format(y.shape))
    ...
    if z is None:
        ...
        if z.ndim != 1:
            raise ValueError("Need `z` to be of either None, an iterable, or "
