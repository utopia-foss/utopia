...
def cooperators(dm: DataManager, *, out_path: str, uni: int=0, fmt: str=None, save_kwargs: dict=None, **plot_kwargs):
    """Calculates the frequency of cooperators performs a lineplot
    ...
    data = [(int(name[5:]), np.count(dset)) for name, dset in grp.items()]
    data.sort()
