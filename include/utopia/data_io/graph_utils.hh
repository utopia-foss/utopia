...
// helper functions for checking properties of adaptor types for
// save_graph_properties
                      ...
                      std::tuple< Adaptors... >&         adaptor_tuple)
{
    ...
    static_assert(
        std::is_same_v< ObjectType, typename Graph::vertex_property_type > or
            std::is_same_v< ObjectType, typename Graph::edge_property_type > or
            std::is_same_v< ObjectType, typename Graph::vertex_descriptor > or
